...
<table>
    <tr>
        <td>
            <img src="./static/img/01homepage.png"> 
        </td>
        <td>    
            <img src="./static/img/02homepage2.png">
        </td>
    </tr>
    <tr>
        <td>
            <img src="./static/img/03budget-maker.png">
        </td>
        <td>
            <img src="./static/img/04tracker.png">
        </td>
    </tr>
    <tr>
        <td>
            <img src="./static/img/05wishlist.png">
        </td>
        <td>
            <img src="./static/img/06rss-feed.png">
        </td>
    </tr>
</table>
